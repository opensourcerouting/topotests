...
#
# test_fabricd_folded_clos_01_numbered.py
...
"""
test_fabricd_folded_clos_01_numbered.py: Test for OpenFabric Folded Clos Topo.
...
topoJson = open('{0}/topo/numbered/clos_topo.json'.format(CWD)).read()
