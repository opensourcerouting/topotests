...
#
# test_fabricd_folded_clos_02_numbered_single_tier0.py
...
"""
test_fabricd_folded_clos_02_numbered_single_tier0.py: Test for OpenFabric Folded Clos Topo.
...
topoJson = open('{0}/topo/numbered/clos_topo_single_tier0.json'.format(CWD)).read()
