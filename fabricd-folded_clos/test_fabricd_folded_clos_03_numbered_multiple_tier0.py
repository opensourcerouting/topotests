...
#
# test_fabricd_folded_clos_03_numbered_multiple_tier0.py
...
"""
test_fabricd_folded_clos_03_numbered_multiple_tier0.py: Test for OpenFabric Folded Clos Topo.
...
topoJson = open('{0}/topo/numbered/clos_topo_multiple_tier0.json'.format(CWD)).read()
