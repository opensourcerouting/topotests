...
#
# test_fabricd_butterfly_06_unnumbered_single_tier0.py
...
"""
test_fabricd_butterfly_06_unnumbered_single_tier0.py: Test for OpenFabric Butterfly Topo
...
topoJson = open('{0}/topo/unnumbered/butterfly_topo_single_tier0.json'.format(CWD)).read()
...
def test_add_tier0_and_check_convergence():
    ...
    logger.info('Adding "fabric-tier 0" to f4 openfabric config')
    tgen.gears['f4'].vtysh_cmd('configure terminal\nrouter openfabric 1\nfabric-tier 0\nend', isjson=False)
